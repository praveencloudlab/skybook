...
ALTER TABLE booking_passengers ADD COLUMN IF NOT EXISTS seat_assignment_mode varchar(10);
...
UPDATE booking_passengers SET seat_assignment_mode = 'MANUAL' WHERE seat_assignment_mode IS NULL;
...
ALTER TABLE booking_passengers ALTER COLUMN seat_assignment_mode SET NOT NULL;
